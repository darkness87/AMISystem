...
public class DashBoardServiceImpl implements DashBoardService {
		...
		for (int i = 0; i < data.size(); i++) {
			...
			if (data.get(i).getDay().equals(today)) {
				...
				if (data.get(i + 1).getSum() == 0) {
					...
					useDayHourAllListVO.setUse(Math.round(((data.get(i + 1).getSum() - data.get(i).getSum()) / 1000.000f)*1000)/1000.000f );
				}

				useDayHourAllListVO.setLp(data.get(i).getSum());

				if (data.get(i).getHour() >= hour) {
					useDayHourAllListVO.setUse(Float.NaN);
				}
	...
	public WeatherDataVO getWeatherDataWeatherAll() throws Exception {
		...
		float count = (failCount / (houseCount * 1.0f)) * 100.0f;
	...
	public ReadingDayInfoVO getReadingDayInfo() throws Exception {
		...
		readingDayInfoVO.setReadingRate(
				Math.round(((successCount / (reading.getHOUSECOUNT() * 1.0f)) * 100.0f) * 100) / 100.0f);
	...
	public RateRealVO getReadingRateDayTime() throws Exception {
		...
		if (rate.get_id().equals(today)) {
			rateRealVO.setRealMeterReadingRate(
					Math.round(((Float.valueOf(rate.getLp()) / (rate.getTotal() * 1.0f)) * 100.0f) * 100) / 100.0f);
			rateRealVO.setRealTimelyRate(
					Math.round(((Float.valueOf(rate.getOn()) / (rate.getTotal() * 1.0f)) * 100.0f) * 100) / 100.0f);
		}
	...
	public RateRealVO getReadingRateDayHourAll() throws Exception {
		...
		List<EstateSeqInterfaceVO> estate = estateDAO.getEstate(); // 단지 목록
		...
		for (EstateSeqInterfaceVO data : estate) {
			...
			AggregationResults<HourRateTemp> estateLpResult = mongoTemplate.aggregate(aggregation, collectionEstateName,
					HourRateTemp.class);
			...
			AggregationResults<HourRateTemp> estateOnResult = mongoTemplate.aggregate(aggregation, collectionEstateName,
					HourRateTemp.class);
			...
			houseCount = houseCount + data.getCNT_HOUSE();
	...
	public List<RateListCountVO> getHourRateCount(List<HourRateTemp> data) throws Exception {
		...
		for (int i = 0; i < 24; i++) {
			...
			if (i == 0) {
				rateListCountVO.setCount(data.get(0).getCount() + data.get(1).getCount() + data.get(2).getCount()
						+ data.get(3).getCount());
			} else if (i == 1) {
				rateListCountVO.setCount(data.get(4).getCount() + data.get(5).getCount() + data.get(6).getCount()
						+ data.get(7).getCount());
			} else if (i == 2) {
				rateListCountVO.setCount(data.get(8).getCount() + data.get(9).getCount() + data.get(10).getCount()
						+ data.get(11).getCount());
			} else if (i == 3) {
				rateListCountVO.setCount(data.get(12).getCount() + data.get(13).getCount() + data.get(14).getCount()
						+ data.get(15).getCount());
			} else if (i == 4) {
				rateListCountVO.setCount(data.get(16).getCount() + data.get(17).getCount() + data.get(18).getCount()
						+ data.get(19).getCount());
			} else if (i == 5) {
				rateListCountVO.setCount(data.get(20).getCount() + data.get(21).getCount() + data.get(22).getCount()
						+ data.get(23).getCount());
			} else if (i == 6) {
				rateListCountVO.setCount(data.get(24).getCount() + data.get(25).getCount() + data.get(26).getCount()
						+ data.get(27).getCount());
			} else if (i == 7) {
				rateListCountVO.setCount(data.get(28).getCount() + data.get(29).getCount() + data.get(30).getCount()
						+ data.get(31).getCount());
			} else if (i == 8) {
				rateListCountVO.setCount(data.get(32).getCount() + data.get(33).getCount() + data.get(34).getCount()
						+ data.get(35).getCount());
			} else if (i == 9) {
				rateListCountVO.setCount(data.get(36).getCount() + data.get(37).getCount() + data.get(38).getCount()
						+ data.get(39).getCount());
			} else if (i == 10) {
				rateListCountVO.setCount(data.get(40).getCount() + data.get(41).getCount() + data.get(42).getCount()
						+ data.get(43).getCount());
			} else if (i == 11) {
				rateListCountVO.setCount(data.get(44).getCount() + data.get(45).getCount() + data.get(46).getCount()
						+ data.get(47).getCount());
			} else if (i == 12) {
				rateListCountVO.setCount(data.get(48).getCount() + data.get(49).getCount() + data.get(50).getCount()
						+ data.get(51).getCount());
			} else if (i == 13) {
				rateListCountVO.setCount(data.get(52).getCount() + data.get(53).getCount() + data.get(54).getCount()
						+ data.get(55).getCount());
			} else if (i == 14) {
				rateListCountVO.setCount(data.get(56).getCount() + data.get(57).getCount() + data.get(58).getCount()
						+ data.get(59).getCount());
			} else if (i == 15) {
				rateListCountVO.setCount(data.get(60).getCount() + data.get(61).getCount() + data.get(62).getCount()
						+ data.get(63).getCount());
			} else if (i == 16) {
				rateListCountVO.setCount(data.get(64).getCount() + data.get(65).getCount() + data.get(66).getCount()
						+ data.get(67).getCount());
			} else if (i == 17) {
				rateListCountVO.setCount(data.get(68).getCount() + data.get(69).getCount() + data.get(70).getCount()
						+ data.get(71).getCount());
			} else if (i == 18) {
				rateListCountVO.setCount(data.get(72).getCount() + data.get(73).getCount() + data.get(74).getCount()
						+ data.get(75).getCount());
			} else if (i == 19) {
				rateListCountVO.setCount(data.get(76).getCount() + data.get(77).getCount() + data.get(78).getCount()
						+ data.get(79).getCount());
			} else if (i == 20) {
				rateListCountVO.setCount(data.get(80).getCount() + data.get(81).getCount() + data.get(82).getCount()
						+ data.get(83).getCount());
			} else if (i == 21) {
				rateListCountVO.setCount(data.get(84).getCount() + data.get(85).getCount() + data.get(86).getCount()
						+ data.get(87).getCount());
			} else if (i == 22) {
				rateListCountVO.setCount(data.get(88).getCount() + data.get(89).getCount() + data.get(90).getCount()
						+ data.get(91).getCount());
			} else if (i == 23) {
				rateListCountVO.setCount(data.get(92).getCount() + data.get(93).getCount() + data.get(94).getCount()
						+ data.get(95).getCount());
			}
